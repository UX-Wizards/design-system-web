  ...
  return (
    <div className="container">
      ...
      <UXWSubsection anchor="about--personality" title="Personality">
        ...
        <p>
        Empathetic &amp; Approachable <br />
        Understanding, unpretentious, and accessible.
        </p>
        <p>
        Adventurous &amp; Imaginative <br />
      ...
      <UXWSubsection anchor="about--values" title="Values">
        <ul className="list-disc list-inside">
          ...
          <li>Growth - We’re not looking for experts or perfection. We strive for new experiences, never perfection. </li>
          <li>Collaboration - Share knowledge and work together. Learn from others and in return teach others, so we may rise together</li>
          <li>Initiative - We wouldn’t be here without the volunteers that step up and get things done.</li>
        </ul>
      </UXWSubsection>
    </div>
  )
