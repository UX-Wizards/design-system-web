function UXWColors(props) {
  return (
    <div className="container">
        ...
        <br />This page provides a directory of available UX Wizards colors, and then color use guidelines to maintain consistency across UX Wizards-branded websites.
      </p>
      ...
      <UXWSubsection anchor="colors--palette" title="Our Palette">
        ...
        Our palette consists of neutral, pleasing tones balanced by vivid and eccentric colors. This color palette has been carefully chosen to provide versatility and function while still providing boundless room for expression.
        </p>

        <p className="pb-12 max-w-prose">
        Though our palette is established, we encourage experimentation through blending modes and gradients. A good rule of thumb is to start with the base color in the left column, and then expand to alternate shades as you play around. Have fun... the results could be spellbinding!
        </p>
      </UXWSubsection>
            ...
            <div className="flex flex-col w-1/3">
              ...
              <div className="flex flex-row p-8 items-center justify-center">
                ...
                <p className="text-left px-4 pt-6 col-span-2 pb-4">
                  <span className="font-bold">Global Token:</span> <br /><span className="font-normal">uxwcolor-acid-1</span><br /><br />
...
`}
            ...
            <div className="flex flex-col w-2/3">
              ...
              <div className="flex flex-row mt-7 ml-5 mr-4">
                ...
                <div className="flex flex-none w-1/2 items-center justify-left pl-16">
                 <div className="box h-32 w-32 rounded-md uxw-bg-acid-2 border-2 border-gray-300 m-4 z-1">
                  ...
                  <p className="text-left p-4">
                    <span className="font-bold">Global Token:</span> <br /><span className="font-normal">uxwcolor-acid-2</span><br /><br />
...
`}
              ...
              <div className="flex flex-row mt-7 ml-5 mr-4">
                ...
                <div className="flex flex-none w-1/2 items-center justify-left pl-16">
                 ...
                 <div className="box h-32 w-32 rounded-md uxw-bg-acid-3 border-2 border-gray-300 m-4 z-1">
                    <p className="z-2 text-left text-white pl-2 pt-1"><span className="text-black font-bold">A </span>FAIL</p>
                    <p className="z-2 text-left text-white pl-2"><span className="font-bold">A </span>PASS</p>
                 </div>

                  <p className="text-left p-4 col-span-2">
                    <span className="font-bold">Global Token:</span> <br /><span className="font-normal">uxwcolor-acid-3</span><br /><br />
              ...
              <div className="flex flex-col w-1/3">
                ...
                <div className="flex flex-row p-8 items-center justify-center">
                  ...
                  <p className="text-left px-4 pt-6pb-4">
                    <span className="font-bold">Global Token:</span> <br /><span className="font-normal">uxwcolor-merlinsbeard-1</span><br /><br />
                ...
                <div className="flex flex-col">
                  ...
                  <div className="flex flex-row mt-7 ml-5 mr-4">
                    ...
                    <div className="flex flex-none w-1/2 items-center justify-left pl-16">
                      ...
                      <div className="box h-32 w-32 rounded-md uxw-bg-merlins-beard-2 border-2 border-gray-300 m-4 z-1">
                       <p className="z-2 text-left pl-2 pt-1"><span className="text-black font-bold">A </span>PASS</p>
                       <p className="z-2 text-left text-black pl-2"><span className="text-white font-bold">A </span>FAIL</p>
                      </div>

                      <p className="text-left col-span-2 p-4">
                        <span className="font-bold">Global Token:</span> <br /><span className="font-normal">uxwcolor-merlinsbeard-2</span><br /><br />
...
`}
                  ...
                  <div className="flex flex-row mt-7 ml-5 mr-4">
                    ...
                    <div className="flex flex-none w-1/2 items-center justify-left pl-16">
                      ...
                      <div className="box h-32 w-32 rounded-md uxw-bg-merlins-beard-3 border-2 border-gray-300 m-4">
                        <p className="z-2 text-left pl-2 pt-1"><span className="text-black font-bold">A </span>PASS</p>
                        <p className="z-2 text-left text-black pl-2"><span className="text-white font-bold">A </span>FAIL</p>
                      </div>

                      <p className="text-left col-span-2 p-4">
                        <span className="font-bold">Global Token:</span> <br /><span className="font-normal">uxwcolor-merlinsbeard-3</span><br /><br />
...
`}
                  ...
                  <div className="flex flex-row mt-7 ml-5 mr-4">
                    ...
                    <div className="box h-32 w-32 rounded-md uxw-bg-merlins-beard-4 border-2 border-gray-300 m-4">
                      <p className="z-2 text-left text-white pl-2 pt-1"><span className="text-black font-bold">A </span>FAIL</p>
                      <p className="z-2 text-left text-white pl-2"><span className="text-white font-bold">A </span>PASS</p>
                    </div>

                    <p className="text-left col-span-2 p-4">
                      <span className="font-bold">Global Token:</span> <br /><span className="font-normal">uxwcolor-merlinsbeard-4</span><br /><br />
...
`}
      ...
      <UXWSubsection anchor="colors--secondary" title="Secondary Colors">
        ...
        <p className="pb-16 max-w-prose">Use <span className="font-bold">Steel</span> and <span className="font-bold">Mana</span> as supporting tones to help build environments in your UXW content.
        </p>
        </div>
       ...
       <div className="flex flex-row pb-10">
         ...
         <div className="flex flex-col w-1/3">
          ...
          <div className="flex flex-row p-8 items-center justify-center">
            ...
            <p className="text-left px-4 pt-6 col-span-2 pb-4">
              <span className="font-bold">Global Token:</span> <br /><span className="font-normal">uxwcolor-steel-1</span><br /><br />
         ...
         <div className="flex flex-col w-2/3">
            ...
            <div className="flex flex-row mt-7 ml-5 mr-4">
              ...
              <div className="flex flex-none w-1/2 items-center justify-left pl-16">
                ...
                <div className="box h-32 w-32 rounded-md uxw-bg-steel-2 border-2 border-gray-300 m-4">
                ...
                <p className="text-left col-span-2 p-4">
                  <span className="font-bold">Global Token:</span> <br /><span className="font-normal">uxwcolor-steel-2</span><br /><br />
...
`}
            ...
            <div className="flex flex-row mx-4 mt-4">
              ...
              <div className="flex flex-none w-1/2 items-center justify-left pl-16">
                ...
                <div className="box h-32 w-32 rounded-md uxw-bg-steel-3 border-2 border-gray-300 m-4">
                  <p className="text-left text-black pl-2 pt-1"><span className=" font-bold">A </span>PASS</p>
                  <p className="text-left text-black pl-2"><span className="text-white font-bold">A </span>FAIL</p>
               </div>

                <p className="text-left col-span-2 p-4">
                  <span className="font-bold">Global Token:</span> <br /><span className="font-normal">uxwcolor-steel-3</span><br /><br />
            ...
            <div className="flex flex-col w-1/3">
              ...
              <div className="flex flex-row p-8 items-center justify-center">
                ...
                <p className="text-left col-span-2 pt-4 pb-4">
                  <span className="font-bold">Global Token:</span> <br /><span className="font-normal">uxwcolor-mana-1</span><br /><br />
              ...
              <div className="flex flex-col">
                ...
                <div className="flex flex-row mt-7 ml-5 mr-4">
                  ...
                  <div className="flex flex-none w-1/2 items-center justify-left pl-16">
                    ...
                    <div className="box h-32 w-32 rounded-md uxw-bg-mana-2 border-2 border-gray-300 m-4">
                    ...
                    <p className="text-left col-span-2 p-4">
                      <span className="font-bold">Global Token:</span> <br /><span className="font-normal">uxwcolor-mana-2</span><br /><br />
...
`}
                ...
                <div className="flex flex-row mt-7 ml-5 mr-4">
                  ...
                  <div className="flex flex-none w-1/2 items-center justify-left pl-16">
                    ...
                    <div className="box h-32 w-32 rounded-md uxw-bg-mana-3 border-2 border-gray-300 m-4">
                      <p className="text-left text-white pl-2 pt-1"><span className="text-black font-bold">A </span>FAIL</p>
                      <p className="text-left text-white pl-2"><span className="text-white font-bold">A </span>PASS</p>
                    </div>

                    <p className="text-left col-span-2 p-4">
                     <span className="font-bold">Global Token:</span> <br /><span className="font-normal">uxwcolor-mana-3</span><br /><br />
...
<UXWSubsection anchor="colors--accent" title="Accent Colors">
        ...
        <p className="pb-12">
        <span className="font-bold">Jinx</span> and <span className="font-bold">Elixir</span> should be used with restraint and finesse. Think of these colors as ways to draw attention to specific things on purpose.
        </p>
        </div>
          ...
          <div className="flex flex-row pb-10">
            ...
            <div className="flex flex-col w-1/3">
              ...
              <div className="flex flex-row p-8 items-center justify-center">
                ...
                <p className="text-left col-span-2 pt-4 pb-4">
                  <span className="font-bold">Global Token:</span> <br /><span className="font-normal">uxwcolor-jinx-1</span><br /><br />
            ...
            <div className="flex flex-col w-2/3">
              ...
              <div className="flex flex-row mt-7 ml-5 mr-4">
                ...
                <div className="flex flex-none w-1/2 items-center justify-left pl-16">
                  ...
                  <div className="box h-32 w-32 rounded-md uxw-bg-jinx-2 border-2 border-gray-300 m-4">
                    <p className="text-left text-white pl-2 pt-1"><span className="text-black font-bold">A </span>FAIL</p>
                    <p className="text-left text-white pl-2"><span className="font-bold">A </span>PASS</p>
                  </div>

                  <p className="text-left col-span-2 p-4">
                    <span className="font-bold">Global Token:</span> <br /><span className="font-normal">uxwcolor-jinx-2</span><br /><br />
...
`}
               ...
               <div className="flex flex-row mt-7 ml-5 mr-4">
                 ...
                 <div className="flex flex-none w-1/2 items-center justify-left pl-16">
                  ...
                  <div className="box h-32 w-32 rounded-md uxw-bg-jinx-3 border-2 border-gray-300 m-4">
                    <p className="text-left text-white pl-2 pt-1"><span className="text-black font-bold">A </span>FAIL</p>
                    <p className="text-left text-white pl-2"><span className="font-bold">A </span>PASS</p>
                  </div>

                  <p className="text-left col-span-2 p-4">
                    <span className="font-bold">Global Token:</span> <br /><span className="font-normal">uxwcolor-jinx-3</span><br /><br />
            ...
            <div className="flex flex-col w-1/3">
              ...
              <div className="flex flex-row p-8 items-center justify-center">
                ...
                <p className="text-left px-4 pt-6 pb-4">
                  <span className="font-bold">Global Token:</span> <br /><span className="font-normal">uxwcolor-elixir-1</span><br /><br />
            ...
            <div className="flex flex-col w-2/3">
              ...
              <div className="flex flex-row mt-7 ml-5 mr-4">
                ...
                <div className="flex flex-none w-1/2 items-center justify-left pl-16">
                  ...
                  <div className="box h-32 w-32 rounded-md uxw-bg-elixir-2 border-2 border-gray-300 m-4">
                    <p className="text-left text-black pl-2 pt-1"><span className=" font-bold">A </span>PASS</p>
                    <p className="text-left text-black pl-2"><span className="text-white font-bold">A </span>FAIL</p>
                  </div>

                 <p className="text-left p-4">
                    <span className="font-bold">Global Token:</span> <br /><span className="font-normal">uxwcolor-elixir-2</span><br /><br />
...
`}
            ...
            <div className="flex flex-row mt-7 ml-5 mr-4">
              ...
              <div className="flex flex-none w-1/2 items-center justify-left pl-16">
                ...
                <div className="box h-32 w-32 rounded-md uxw-bg-elixir-3 border-2 border-gray-300 m-4">
                  <p className="text-left text-white pl-2 pt-1"><span className="text-black font-bold">A </span>FAIL</p>
                  <p className="text-left text-white pl-2"><span className="font-bold">A </span>PASS</p>
                </div>

                <p className="text-left col-span-2 p-4">
                  <span className="font-bold">Global Token:</span> <br /><span className="font-normal">uxwcolor-elixir-3</span><br /><br />
