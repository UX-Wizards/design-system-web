  ...
  return (
    <div className="container">
       <div className="flex-col flex-shrink-0 px-4 py-4">
          ...
          <div className="container">
            <h2 className="text-2xl pb-4">Logos</h2>
            ...
            <h2 className="text-2xl pb-4 pt-16">Clearance</h2>
            ...
            <h2 className="text-2xl pb-4 pt-12">Icongraphy Style</h2>
            <p>Icon styles explain comes here, Half-giant jinxes peg-leg gillywater broken glasses large black dog Great Hall. Nearly-Headless Nick now string them together, and answer me this, which creature would you be unwilling to kiss?</p>

            <img className="pt-16"src="assets/icongraphy.png" alt=""/>

            <h2 className="text-2xl pb-4 pt-16">Library</h2>
